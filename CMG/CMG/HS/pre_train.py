...
def get_params():
    ...
    parser.add_argument("--seed", type=int, default=37697,help='random seed')
    parser.add_argument("--dataset_t",type = str, default = 'HS13',help='the data of the target')
    parser.add_argument("--cls_batch_size",  type=int, default=197,help='shot num per class')
    ...
    parser.add_argument("--episode", type=int, default=1900, help='episode')
    ...
    parser.add_argument('--pro_num', type=int, default=40, help='0.5,0.7,1.2,1.5,2.5,3.')
...
def pre_train():
    ...
    for episode in range(params['episode']):
       ...
       if episode%100==0:
           print("episode:",episode,"loss:",float(loss))
       ...
       if episode == 0 or episode % 100 == 0:
           ...
           with torch.no_grad():
            ...
            torch.save(feture_encoder.state_dict(),
                              str("../HS/checkpoints_HS/FE_Pre.pkl"))


    return torch.load("../HS/checkpoints_HS/FE_Pre.pkl")
